					...
					subitem
						...
						.onClick(async () => {
							if (file instanceof TFolder) {
								...
								console.log("GET METADATA", getMetadataDate(file, plugin.app, plugin.settings));
								transferNote(null, file as TFile, plugin.app, plugin.settings, undefined, undefined, getMetadataDate(file, plugin.app, plugin.settings));
							}
						});
					submenu.addItem((subitem) => {
						subitem
