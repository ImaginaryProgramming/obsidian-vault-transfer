...
export class SettingTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        this.containerEl.createEl("p", { text: "The date variable to use for the output folder or in override path. For folder, will use the folder note (inside, outside, or named index) data." });
